...
// Post Class
$post_class = array( 'fy-product' );

// Post Appearance
array_push( $post_class, 'fy-product-' . get_theme_mod( 'dox_post_appearance', dox_default( 'dox_post_appearance' ) ) );
?>
<div class="fy-product-column fy-flex-column-25 fy-flex-column-desktop-wide-25 fy-flex-column-desktop-33 fy-flex-column-tablet-50 fy-flex-column-phone-100">
	<div <?php wc_product_class( $post_class, $product ); ?>>
		<?php
		/**
